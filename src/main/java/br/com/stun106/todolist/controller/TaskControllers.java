...
import br.com.stun106.todolist.interfaces.ITaskRepository;
...
public class TaskControllers {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (currentData.isAfter(taskModel.getStartAt()) || currentData.isAfter(taskModel.getEndAt())){
            ...
            msg.put("msg","A data de inicio / data de termino deve ser maior que a data atual.");
        ...
        if (taskModel.getStartAt().isAfter(taskModel.getEndAt())){
            ...
            Map<String,String> msg = new HashMap<String,String>();
            msg.put("msg","A data de inicio / data de termino deve ser menor que a data atual.");
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(msg);
